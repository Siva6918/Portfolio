        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {certifications.map((cert) => (
            <div
              ...
              className="glass-card p-5 rounded-xl space-y-3 group hover:border-[#8b5cf6]/30 transition-all"
            >
              {/* Org + Verify Icon */}
              ...
              <div className="pt-2 border-t border-[#27272a] flex items-center justify-between text-[10px] font-mono text-[#52525b]">
                ...
                {cert.credentialUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-1 text-[#a5b4fc] hover:text-[#c4b5fd] transition-colors"
                  >
                    <span>Verify</span>
